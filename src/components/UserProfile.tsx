...
export default function UserProfile({ user }: Props) {
  const { image, username, name, email, followers, followings, posts } = user;
  const info = [
  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-center py-12 border-b border-neutral-200">
